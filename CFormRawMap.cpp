...
void CFormRawMap::generateMapFromMapGrid(CPointsMapPtr thePntsMap,int color)
{
	...
	*/
	...
	//CPointsMapPtr sssdffff((


//	mapss.getPo
	/*
	if( !theMapNew.m_pointsMaps.empty() )
		thePntsMap = theMapNew.m_pointsMaps[0];
	else if (theMapNew.m_colourPointsMap.present())
		thePntsMap = theMapNew.m_colourPointsMap;*/
...
// Generate the map:
void CFormRawMap::generateMap(CRawlog rawlog)
{
    WX_START_TRY
